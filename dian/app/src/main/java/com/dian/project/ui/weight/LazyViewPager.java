package com.dian.project.ui.weight;
...
//            mAdapter.registerDataSetObserver(mObserver);
    ...
    void populate() {
        ...
        if (DEBUG)  Log.e(TAG, "populating: startPos=" + startPos + " endPos=" + endPos);
        ...
        for (int i = 0; i < mItems.size(); i++) {
            ...
            if ((ii.position < startPos || ii.position > endPos) && !ii.scrolling) {
                if (DEBUG) Log.e(TAG, "removing: " + ii.position + " @ " + i);
                mItems.remove(i);
                i--;
                mAdapter.destroyItem(this, ii.position, ii.object);
                ...
                while (lastPos <= endPos && lastPos < ii.position) {
                    if (DEBUG)  Log.e(TAG, "inserting: " + lastPos + " @ " + i);
        ...
        if (lastPos < endPos) {
            ...
            while (lastPos <= endPos) {
                if (DEBUG) Log.e(TAG, "appending: " + lastPos);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != GONE && (ii = infoForChild(child)) != null) {
                ...
                if (DEBUG)  Log.e(TAG, "Positioning #" + i + " " + child + " f=" + ii.object
    ...
    public void computeScroll() {
        if (DEBUG)  Log.e(TAG, "computeScroll: finished=" + mScroller.isFinished());
        if (!mScroller.isFinished()) {
            if (mScroller.computeScrollOffset()) {
                if (DEBUG)  Log.e(TAG, "computeScroll: still scrolling");
                int oldX = getScrollX();
                int oldY = getScrollY();
